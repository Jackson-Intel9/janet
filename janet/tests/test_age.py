...
"""
import numpy as np
from ..age import _get_lg_age_bin_edges, _get_lgt_birth, T_BIRTH_MIN
from ..age import _get_sfh_tables, _get_age_weights_from_tables
from ..stars import DEFAULT_MAH_PARAMS, DEFAULT_MS_PARAMS, DEFAULT_Q_PARAMS
